...
namespace FiredepartmentAPI.Migrations
{
    ...
    [Migration("20220305073709_deleteref")]
    partial class deleteref
    {
            ...
            modelBuilder.Entity("FiredepartmentAPI.DbModels.StatusChangeModel", b =>
                {
                    ...
                    b.Property<int?>("PlaceModelPlaceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FiredepartmentAPI.DbModels.StatusChangeModel", b =>
                {
                    ...
                    b.HasOne("FiredepartmentAPI.DbModels.PlaceModel", null)
                        .WithMany("StatusChangeList")
                        .HasForeignKey("PlaceModelPlaceId");
